...
class DataSource {
    fun getAllListOfPayee(): Flow<List<Payees>> = flow {
        ...
        emit(arrayListOf(
            ...
            Payees((R.drawable.man).toString(),"Kareem Chitta ","090078601","Al Baraka Bank")
        ))
    }
    ...
    fun getAllAccountList(): Flow<List<Accounts>> = flow {
        ...
        emit(arrayListOf(
            ...
            Accounts("Janger Turke ","0132739832987321","2000"),
    ...
    fun getAllTransPurposeList(): Flow<List<PurposeListItem>> = flow {
        ...
        emit(arrayListOf(
            ...
            PurposeListItem("Charity"),
            PurposeListItem("Loan"),
